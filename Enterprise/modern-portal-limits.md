...
|Security groups  <br/> |20 per site  <br/> |Threshold  <br/> |The number of security groups affects the scale of many queries in modern portal sites. We recommend that you limit the permission set to as small a set of Security Groups as possible.  <br/> |
|Items in the navigation bar  <br/> |100 per site  <br/> |Threshold  <br/> |We recommend adding fewer than 100 items to site navigation.  <br/> For more information, see [Optimize page weight in SharePoint Online modern site pages](modern-page-weight-optimization.md). <br/> |
