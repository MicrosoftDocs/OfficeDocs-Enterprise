OneDrive for Business Geo Move 
===============================
...
Note: We recommend running Get-SPOGeoMoveStateCompatibility and ValidationOnly prior to initiating OneDrive geo move.
