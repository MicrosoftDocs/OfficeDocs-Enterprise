...
- **Skype for Business On-premise in a Hybrid environment with Office 365**
  ...
  - All SFB servers must have the latest CU Installed, Please review the article [Skype for Business Server Update](https://docs.microsoft.com/en-us/skypeforbusiness/sfb-server-updates) for the latest CUs and installation instructions.
...
- **Exchange Server On-premise in a Hybrid environment with Office 365**
  ...
  - All Exchange servers must have the latest CU installed, Please review the article [Upgrade Exchange to the latest Cumulative Update](https://docs.microsoft.com/en-us/exchange/plan-and-deploy/install-cumulative-updates?view=exchserver-2019) for the latest CUs and installation instructions.
