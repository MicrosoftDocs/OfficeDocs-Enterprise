...
![Contoso's Windows Server AD forest and domains across the world](media/Contoso_Poster/Contoso_WW_ID.png)
...
![Contoso's existing infrastructure to support federated authentication for customers and partners](media/Contoso_Poster/Federated_ID.png)
...
![Contoso's directory synchronization infrastructure](media/Contoso_Poster/DirSync.png)
...
![Geographical distribution of Contoso authentication traffic for regional offices](media/Contoso_Poster/Auth_GeoDist.png)
...
![The redundant authentication infrastructure in Azure IaaS for the Paris headquarters](media/Contoso_Poster/Paris_Auth_Redun.png)
