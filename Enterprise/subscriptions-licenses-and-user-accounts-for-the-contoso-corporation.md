...
![Contoso's organization, subscriptions, licenses, user accounts and tenants](media/Contoso_Poster/Subscriptions.png)
...
![Contoso's structure for Azure subscriptions](media/Contoso_Poster/Subscriptions_Nested.png)
