...
2. **Sign in and add your internet domain(s) to Office 365**. Sign into the [Microsoft 365 admin center](https://portal.microsoft.com), click **Setup > Domains**, and then click **New domain**. Add one or more domains to your Office 365 subscription without adding users or migrating email. 
