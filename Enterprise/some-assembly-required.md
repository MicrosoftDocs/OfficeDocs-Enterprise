...
![Vertical scaling provided by Azure SQL Database.](media/Storage_Poster/CloudStor-VertScale.png)
  
With horizontal scaling, you can add new databases as needed.
  
![Horizontal scaling provided by Azure SQL Database.](media/Storage_Poster/CloudStor-HorizScale.png)
...
![Stretch Database with SQL Server 2016.](media/Storage_Poster/CloudStor-Stretch.png)
...
![Uncommon attributes of Cosmos DB vs. Azure Tables vs. Azure SQL Database](media/Storage_Poster/CloudStor-Table.png)
