...
[!NOTE]
Files used by SPFX web parts can only utilize the Public CDN and the ClientSideAssets folder is a default origin for Public CDN. If you add the ClientSideAssets folder to the Private CDN Origins list then it will generate an error and your custom web part will fail to render.
