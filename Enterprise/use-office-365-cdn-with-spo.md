...
If you want to disable auto-rewriting for specific URLs on a page, check out the page and add the query string parameter **?NoAutoReWrites=true** to the end of each link you want to disable.
