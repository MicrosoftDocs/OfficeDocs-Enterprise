 ...
 **Summary:** Create and configure the Active Directory Federation Services (AD FS) servers for your high availability federated authentication for Office 365 in Microsoft Azure.
...
![Phase 3 of the high availability Office 365 federated authentication infrastructure in Azure with the AD FS servers](images/f39b2d2f-8a5b-44da-b763-e1f943fcdbc4.png)
  
## Next step

Use [High availability federated authentication Phase 4: Configure web application proxies](high-availability-federated-authentication-configure-web-application.md) to continue configuring this workload.
