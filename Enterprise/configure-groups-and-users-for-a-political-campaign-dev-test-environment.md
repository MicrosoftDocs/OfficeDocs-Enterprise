...
- Your trial subscription organization name: ![](./media/Common_Images/TableLine.png) 
    
    For example, for the trial subscription domain name of contoso.onmicrosoft.com, the organization name is "contoso".
    
- The Office 365 global administrator name: ![](./media/Common_Images/TableLine.png).onmicrosoft.com
