---
title: "Azure AD Pass-through Authentication for your dev/test environment"
ms.author: josephd
...
description: "Summary: Configure Azure AD Pass-through Authentication for your dev/test environment."
---

# Azure AD Pass-through Authentication for your dev/test environment

 **Summary:** Configure Azure AD Pass-through Authentication for your dev/test environment.
  
Many organizations use Azure Active Directory (AD) Connect and directory synchronization to synchronize the set of accounts in their on-premises Windows Server Active Directory (AD) forest to the set of accounts in Office 365. This article describes how you can add directory synchronization with Azure AD Pass-through Authentication to the Office 365 dev/test environment, resulting in the following configuration.
  
![The Office 365 dev/test environment with Pass-through Authentication](images/be5b37b0-f832-4878-b153-436c31546e21.png)
  
This configuration consists of: 
  
- An Office 365 E5 Trial Subscription, which expires 30 days from when you create it.
- A simplified organization intranet connected to the Internet, consisting of three virtual machines on a subnet of an Azure virtual network (DC1, APP1, and CLIENT1). Azure AD Connect runs on APP1 to synchronize the Windows Server AD domain to Office 365 and poll the Azure AD tenant of the Office 365 subscription for pass-through authentication requests.
    
There are two phases to setting up this dev/test environment:
  
1. Create the Office 365 dev/test environment (the DC1, APP1, and CLIENT1 virtual machines in an Azure virtual network with an Office 365 E5 trial or perpetual subscription).
...
- An Office 365 E5 Trial or perpetual subscription.
- A simplified organization intranet connected to the Internet, consisting of the DC1, APP1, and CLIENT1 virtual machines on a subnet of an Azure virtual network.
    
## Phase 2: Install Azure AD Connect on APP1

Once installed and configured for pass-through authentication, Azure AD Connect synchronizes the set of accounts in the CORP Windows Server AD domain with the set of accounts in your Office 365 trial subscription and handles pass-through authentication requests queued by the Azure AD tenant of your Office 365 subscription. 

The following procedure steps you through installing and configuring Azure AD Connect on APP1 for pass-through authentication and verifying that it works.
...
7. On the **Install required components** page, click **Install**. Wait for the Azure AD Connect components to install.

8. On the **User sign-in** page, click **Pass-through authentication**, and then click **Next**.

8. On the **Connect your directories** page, click **Add Directory**.

9. On the **AD forest account** page, click **Use existing AD account**, type **CORP\\User1** in **Username,** type its password in **Password**, and then click **OK**.
...
![The Office 365 dev/test environment with directory synchronization and pass-through authentication](images/be5b37b0-f832-4878-b153-436c31546e21.png)
...
When you are ready to deploy pass-through authentication for your organization, see [Deploy Office 365 directory synchronization in Microsoft Azure](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-quick-start).
