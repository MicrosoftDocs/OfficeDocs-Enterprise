...
3. Set up a table that includes the following rows:</br> 
    - Realm
...
Copy the *Identifier* value into the *Realm* property into a table  (An example table is provided after Step 7.)
4. Save your changes.
